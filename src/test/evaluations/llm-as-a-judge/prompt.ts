...
The answers are medically related. If the GIVEN ANSWER contains wrong medical indication with respect to the EXPECTED ANSWERS, the score must be 0. Even a change of language (e.g. starting in the right language but then switching to another one) lead to a score of 0.
